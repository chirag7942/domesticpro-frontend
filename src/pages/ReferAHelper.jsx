                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-textDark mb-4">
                            ...
                            <span className="text-primary">Refer & Earn ₹1,000</span>
                        </h2>
                        <p className="text-textLight max-w-2xl mx-auto leading-relaxed">
                            Connect a hardworking individual with a verified placement opportunity. Once they are successfully placed and begin service, your ₹1,000 reward is guaranteed — no delays, no conditions.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-3 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="referrerName" placeholder="As per your Aadhar card" value={formData.referrerName} onChange={handleChange} required className={INPUT_CLS} />
                                </div>
                                <div>
                                    <label className={LABEL_CLS}>Mobile Number</label>
                                    <input type="tel" name="phone" placeholder="Your active 10-digit number" value={formData.phone}
                                ...
                                <div>
                                    ...
                                    <input type="text" name="upi" placeholder="Reward will be sent here" value={formData.upi} onChange={handleChange} required className={INPUT_CLS} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-3 gap-5">
                                <div>
                                    <label className={LABEL_CLS}>Helper's Full Name</label>
                                    <input type="text" name="helperName" placeholder="As per their Aadhar card" value={formData.helperName} onChange={handleChange} required className={INPUT_CLS} />
                                </div>
                                <div>
                                    <label className={LABEL_CLS}>Helper's Mobile Number</label>
                                    <input type="tel" name="helperPhone" placeholder="Their active 10-digit number" value={formData.helperPhone}
                                ...
                                <div>
                                    ...
                                    <select name="experience" value={formData.experience} onChange={handleChange} required className={INPUT_CLS}>
                                        <option value="">How long have they worked?</option>
                                ...
                                <div className="md:col-span-3">
                                    <label className={LABEL_CLS}>Preferred Work Type</label>
                                ...
                                <div className="md:col-span-3 grid md:grid-cols-2 gap-5">
                                    <FileField label="Aadhar Card — Front Side" name="aadharFront"
                                        onChange={(e) => setFormData((p) => ({ ...p, aadharFront: e.target.files[0] }))} />
                                    <FileField label="Aadhar Card — Back Side" name="aadharBack"
                        ...
                        <div className="flex items-start gap-3 bg-primary/5 border border-primary/20 rounded-xl p-4">
                            ...
                            <p className="text-sm text-primary font-semibold leading-relaxed">
                                Your ₹1,000 reward is transferred directly to your UPI ID once the helper completes their first month of service. Guaranteed. No hidden conditions.
                            </p>
                        </div>

                        <SubmitButton label="Submit Referral & Claim Reward" isSubmitting={isSubmitting} />
                    </form>
                </div>
            </section>
