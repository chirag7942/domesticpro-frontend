...
import houseKeeperImg from "../../assets/japa.png";
    ...
    <>
          ...
          <div className="animate-left">
            ...
            <ul className="text-textLight mb-8 space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span>Trained in post-delivery mother care</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>Expert newborn handling & hygiene support</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>Feeding, massage & recovery assistance</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>Safe, caring & 24x7 live-in support</span>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-6 scroll-section">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-textDark mb-4">
              Choose Your Japa Category
            </h2>
            <p className="text-textLight max-w-2xl mx-auto">
              Flexible postpartum and newborn care solutions designed to support
              mothers and babies with trained, experienced Japa.
            </p>
          </div>
            ...
            >
              ...
              <ul className="text-textLight mb-8 space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span>Full-time postpartum & newborn care support</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Mother recovery & baby hygiene assistance</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Day & night newborn supervision</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Trusted, experienced & caring professionals</span>
                </li>
              </ul>
            ...
            >
              ...
              <ul className="text-textLight mb-8 space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span>Immediate replacement during leave</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>No disruption to mother & baby routine</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Experienced in newborn & recovery care</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Reliable support anytime needed</span>
                </li>
              </ul>
            ...
            >
              ...
              <ul className="text-textLight mb-8 space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span>Professional day-time postpartum support</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Scheduled visits for newborn care</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
                  </span>
                  <span>Trained & compassionate caregivers</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                    ✓
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 scroll-section">
          ...
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-textDark mb-3">
              Why Choose Domestic Pro for Japa Services?
            </h2>

            <p className="text-textLight max-w-2xl mx-auto">
              We provide reliable, verified, and professional Japa with a
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition">
              ...
              <p className="text-textLight text-sm">
                All Japa undergo strict background verification, ID checks, and
                skill screening before placement.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition">
              ...
              <h3 className="font-semibold text-textDark text-lg mb-2">
                Full-Time Japa Support
              </h3>

              <p className="text-textLight text-sm">
                Dedicated Japa who stay with your family and manage daily
                household tasks with care and responsibility.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition">
              ...
              <h3 className="font-semibold text-textDark text-lg mb-2">
                Substitute Japa Support
              </h3>

              <p className="text-textLight text-sm">
                Immediate replacement provided if your regular Japa is
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition">
              ...
              <h3 className="font-semibold text-textDark text-lg mb-2">
                Trusted & Reliable Japa Services
              </h3>

              <p className="text-textLight text-sm">
                Structured onboarding, continuous monitoring, and ongoing
                support to ensure safe, dependable, and professional Japa
                services.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white ">
        <div className="max-w-7xl mx-auto px-6 py-20 scroll-section">
          ...
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-textDark mb-3">
              Roles & Responsibilities of a 24x7 Live-In Japa
            </h2>

            <p className="text-textLight max-w-2xl mx-auto">
              Our professionally trained Japas ensure complete newborn care and
              postpartum support with dedication, expertise, and compassion.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Feeding, burping, diaper changing, and gentle handling of
                  newborns.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Assisting post-delivery recovery, monitoring health, and
                  providing comfort.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Monitoring baby’s sleep routines and ensuring a comfortable
                  environment.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Helping with breastfeeding, formula preparation, and bottle
                  feeding.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Keeping baby’s environment, bedding, and essentials clean and
                  sanitized.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Round-the-clock support for both mother and baby, ensuring
                  care at all times.
                </p>
              </div>
            </div>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-6 py-20 scroll-section">
          ...
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-textDark mb-3">
              Roles & Responsibilities of Substitute Japa Staff
            </h2>

            <p className="text-textLight max-w-2xl mx-auto">
              Our trained Japa staff provide reliable temporary support,
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-textLight text-sm">
                  Quick deployment of verified Japa staff to ensure no
