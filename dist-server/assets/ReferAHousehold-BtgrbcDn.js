...
function ReferHousehold() {
  ...
  const handleCheckbox = (value) => setFormData((prev) => ({
    ...prev,
    workTypeRequired: prev.workTypeRequired.includes(value) ? prev.workTypeRequired.filter((x) => x !== value) : [...prev.workTypeRequired, value]
  }));
  const handleSubmit = (e) => {
    ...
    if (formData.workTypeRequired.length === 0) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      SEO,
      {
        title: "Refer a Household & Get Trusted Domestic Help | Verified Staff Matching",
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-bgLight border-t border-borderLight py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-textDark mb-4", children: [
          "Refer a Household &",
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-primary", children: "Be Their Genie" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-textLight max-w-2xl mx-auto leading-relaxed", children: "Know a family searching for a trusted domestic helper? Your genie is here — refer them to us and we'll make the perfect match happen." })
      ] }),
      /* @__PURE__ */ jsxs(
        "form",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-5", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: LABEL_CLS, children: "Employer's Full Name" }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: LABEL_CLS, children: "Employer's Mobile Number" }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "tel",
                      ...
                      onChange: (e) => {
                        const v = e.target.value.replace(/\D/g, "");
                        if (v.length <= 10) setFormData((p) => ({ ...p, employerPhone: v }));
                      },
                      required: true,
                      pattern: "[0-9]{10}",
                      maxLength: "10",
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: LABEL_CLS, children: "Experience Required" }),
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      ...
                      className: INPUT_CLS,
                      children: [
                        /* @__PURE__ */ jsx("option", { value: "", children: "Select preferred experience" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-3", children: [
                  /* @__PURE__ */ jsx("label", { className: LABEL_CLS, children: "Type of Engagement Required" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 bg-primary/5 border border-primary/20 rounded-xl p-4", children: [
              /* @__PURE__ */ jsx(Users, { size: 16, className: "text-primary flex-shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-primary font-semibold leading-relaxed", children: "Once referred, our team will personally reach out to the household and ensure they find their ideal helper — swiftly and seamlessly." })
            ] }),
            /* @__PURE__ */ jsx(SubmitButton, { label: "Submit Referral", isSubmitting })
          ]
        },
        `form2-${formKey}`
      )
    ...
    showPopup && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-3xl p-10 max-w-sm w-full text-center shadow-2xl border border-borderLight", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-textLight text-sm mb-7 leading-relaxed", children: "Our team will reach out to the household shortly and find them the perfect helper." }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
