...
/* empty css                */
const Harpreet = "/assets/photo-1567532939604-b6b5b0db2604-Co9w4HoG.avif";
const CSS = `
  .swiper-button-next,
  .swiper-button-prev {
...
function TestimonialCarousel() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "bg-bgLight py-20 px-6", children: [
    /* @__PURE__ */ jsx("style", { children: CSS }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto text-center mb-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold text-textDark mb-4", children: "Trusted by hundreds of households" }),
      /* @__PURE__ */ jsx("p", { className: "text-textLight text-lg max-w-xl mx-auto leading-relaxed", children: "Real stories from families who found their perfect helper through Domestic Pro." })
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(
            Swiper,
            {
              ...
              className: "pb-0",
              children: testimonials.map((item, index) => /* @__PURE__ */ jsx(SwiperSlide, { className: "flex h-auto", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl p-7 border border-borderLight hover:border-primary/30 hover:shadow-[0_8px_32px_rgba(236,95,54,0.10)] transition-all duration-300 flex flex-col justify-between h-full min-h-[280px] w-full", children: [
                /* @__PURE__ */ jsx("div", { className: "flex items-center gap-0.5 mb-4", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 20 20", fill: i < item.rating ? "#EC5F36" : "#E5E7EB", className: "w-4 h-4", children: /* @__PURE__ */ jsx("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }) }, i)) }),
                /* @__PURE__ */ jsxs("p", { className: "text-sm text-textLight leading-relaxed line-clamp-4 flex-1 mb-5", children: [
                  '"',
                  item.review,
                  '"'
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-borderLight", children: [
                  /* @__PURE__ */ jsx(
                    "img",
                    {
                      src: item.image,
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-textDark", children: item.name }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-textLight", children: item.role })
                  ] })
                ] })
              ] }) }, index))
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "custom-pagination mt-6" })
        ]
      }
    )
  ] });
...
export {
  TestimonialCarousel as default
};
